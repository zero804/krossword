...
Offset ClueCell::answerOffsetToOffset( AnswerOffset answerOffset ) {
    switch ( answerOffset ) {
      case OnClueCell: 		return Offset( 0, 0 );
    case OffsetTop: 		return Offset( 0,-1 );
    case OffsetBottom: 		return Offset( 0, 1 );
    case OffsetLeft: 		return Offset(-1, 0 );
    case OffsetRight:		return Offset( 1, 0 );
    case OffsetTopLeft:		return Offset(-1,-1 );
    case OffsetTopRight:	return Offset( 1,-1 );
    case OffsetBottomLeft:	return Offset(-1, 1 );
    case OffsetBottomRight:	return Offset( 1, 1 );
    case OffsetInvalid:
